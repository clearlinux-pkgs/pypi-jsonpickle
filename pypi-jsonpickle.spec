...
Source0  : https://files.pythonhosted.org/packages/d8/56/4351ac08ac5bf7207d6c1f6cfb327ed9599c452ced03ab165810bc87e471/jsonpickle-3.0.0.tar.gz
...
%prep
%setup -q -n jsonpickle-3.0.0
cd %{_builddir}/jsonpickle-3.0.0
pushd ..
cp -a jsonpickle-3.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670497257
