...
Source0  : https://files.pythonhosted.org/packages/03/4f/1dde1e344dc41c40bc3f0eb721d7ddc5fed827bf518ba410c369f6bbaa07/jsonpickle-4.1.0.tar.gz
...
%prep
%setup -q -n jsonpickle-4.1.0
cd %{_builddir}/jsonpickle-4.1.0
pushd ..
cp -a jsonpickle-4.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747870305
