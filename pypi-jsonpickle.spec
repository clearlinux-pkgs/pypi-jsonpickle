...
Source0  : https://files.pythonhosted.org/packages/7b/c3/7b43eb963bfb3fa95385e677bb9d027c56d65d395d9f4bd52833affd1a4f/jsonpickle-3.3.0.tar.gz
...
%prep
%setup -q -n jsonpickle-3.3.0
cd %{_builddir}/jsonpickle-3.3.0
pushd ..
cp -a jsonpickle-3.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725263183
