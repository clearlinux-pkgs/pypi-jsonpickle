...
Source0  : https://files.pythonhosted.org/packages/94/a6/98e63e70a2c1907edb81cff7bae4bf1b2fec2d510ce528653c6c5f2ed931/jsonpickle-3.2.2.tar.gz
...
%prep
%setup -q -n jsonpickle-3.2.2
cd %{_builddir}/jsonpickle-3.2.2
pushd ..
cp -a jsonpickle-3.2.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718920272
