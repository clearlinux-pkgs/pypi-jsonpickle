...
Source0  : https://files.pythonhosted.org/packages/e4/a6/d07afcfdef402900229bcca795f80506b207af13a838d4d99ad45abf530c/jsonpickle-4.1.1.tar.gz
...
%prep
%setup -q -n jsonpickle-4.1.1
cd %{_builddir}/jsonpickle-4.1.1
pushd ..
cp -a jsonpickle-4.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748960177
