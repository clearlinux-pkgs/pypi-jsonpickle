...
Source0  : https://files.pythonhosted.org/packages/fa/2d/806d7ce5743131a6a137c49016ad80db3c3a757288b863795bb50eb99603/jsonpickle-3.2.1.tar.gz
...
%prep
%setup -q -n jsonpickle-3.2.1
cd %{_builddir}/jsonpickle-3.2.1
pushd ..
cp -a jsonpickle-3.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718296381
